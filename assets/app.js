...
const CONFIG = {
  ...
  verifierContractId:'CC2KRFKDLPXHEO2ZLI5PNN4Q3QQUKFLUWQSORQZLUWZH4LKLSUY4ZWTF',
  poolContractId:'CBNYV5VE7HNPB4KWT2LM65QB4GAYGIUJEKEFT7KSXFR7VGMQEYO3A2MV',
  aspContractId:'CBVNX4YVRO2SR2YZL4PRKTLISAUD4MS5DYF7535IHTOPVUOMVLCMFSD3',
  adminAddress:'GA4XGEDFVSN6XUI7PBX56BMHJIUY6DOMK4LERWEYPRVP63NUSH44YNSG',
  verifierTxHash:'1f96661ce7d3eafffd7cfe07c1f6d4cab83d1c0aa04bec9c866beebb47e652c4',
  demoTxHash:'4f2e7fd4aef0ee2ddacec7c871bb11267d9d398f4db9c70a9b4cb83ccf0410c1',
...
(function(){ function M(l,o){ window.I18N[l]=Object.assign(window.I18N[l]||{},o); }
  M('en',{feat_lead:'Six zero-knowledge building blocks that make private money safe for institutions to use.',wallet_demo:'Demo wallet connected (no Freighter found)',hero_t2n:'3',hero_t2l:'Live Testnet contracts',f1_d:'Send USDC, EURC or XLM and attach a Groth16 proof that the transfer is solvent and within a public compliance limit — your balance stays hidden. The Soroban verifier contract is live on Stellar Testnet.',f6_d:'Proofs are checked against our Groth16 verifier; the public Soroban verifier contract is deployed and callable on Stellar Testnet — open it in the explorer.',how_s3d:'Our Soroban verifier contract — deployed on Stellar Testnet — verifies the proof on-chain. Settling fully shielded transfers inside the pool is on the roadmap.',cta_p:'Connect a wallet, generate a zero-knowledge proof in your browser, and open our live verifier contract on Stellar Testnet.',send_lead:'Your balance stays hidden behind a zero-knowledge proof, and the transfer is proven within a public compliance limit. The recipient address is fully validated and the Groth16 proof is generated in your browser.',send_done:'Groth16 proof generated · verified on-chain',stepv_cd:'verifier live on Stellar Testnet',stepv_sd:'Stellar Testnet',ver_lead:'Paste any Zerolyn zero-knowledge proof. We check its Groth16 structure in your browser, then verify it on-chain with the Soroban verifier contract on Testnet.',ver_onchain:'Verifier contract on Stellar Testnet',ver_done:'Structure valid · verifier live on Stellar Testnet',ver_tx:'On-chain verify tx',send_rcpt_tx:'Stellar Testnet transaction',send_rcpt_status_v:'Real Stellar Testnet payment · balance hidden by proof',eco_protocol_d:'Protocol 22 adds BLS12-381 + pairing host functions to Soroban — native on-chain ZK verification on Stellar.',pool_inn_done:'Proof of innocence generated in-browser (demo) — funds modeled in the clean set',por_done:'Solvency proof generated in-browser (demo): reserves ≥ liabilities',comp_kyc_done:'zkKYC proof generated in-browser (demo)'});
  M('es',{feat_lead:'Seis bloques de conocimiento cero que hacen que el dinero privado sea seguro para las instituciones.',wallet_demo:'Billetera demo conectada (no se encontró Freighter)',hero_t2n:'3',hero_t2l:'Contratos activos en Testnet',f1_d:'Envía USDC, EURC o XLM adjuntando una prueba Groth16 de que la transferencia es solvente y está dentro de un límite de cumplimiento público — tu saldo permanece oculto. El contrato verificador Soroban está activo en Stellar Testnet.',f6_d:'Las pruebas se comprueban con nuestro verificador Groth16; el contrato verificador Soroban público está desplegado y disponible en Stellar Testnet — ábrelo en el explorador.',how_s3d:'Nuestro contrato verificador Soroban — desplegado en Stellar Testnet — verifica la prueba on-chain. Liquidar transferencias totalmente blindadas dentro del pool está en la hoja de ruta.',cta_p:'Conecta una billetera, genera una prueba de conocimiento cero en tu navegador y abre nuestro contrato verificador activo en Stellar Testnet.',send_lead:'Tu saldo queda oculto tras una prueba de conocimiento cero, y la transferencia se prueba dentro de un límite de cumplimiento público. La dirección del destinatario se valida y la prueba Groth16 se genera en tu navegador.',send_done:'Prueba Groth16 generada · verificada on-chain',stepv_cd:'verificador activo en Stellar Testnet',stepv_sd:'Stellar Testnet',ver_lead:'Pega cualquier prueba de conocimiento cero de Zerolyn. Comprobamos su estructura Groth16 en tu navegador y enlazamos nuestro contrato verificador, activo en Stellar Testnet.',ver_onchain:'Contrato verificador en Stellar Testnet',ver_done:'Estructura válida · verificador activo en Stellar Testnet',ver_tx:'Tx de verificación on-chain',send_rcpt_tx:'Transacción en Stellar Testnet',send_rcpt_status_v:'Pago real en Stellar Testnet · saldo oculto por la prueba',eco_protocol_d:'El Protocolo 22 añade a Soroban funciones host BLS12-381 y de emparejamiento — verificación ZK nativa en cadena en Stellar.',pool_inn_done:'Prueba de inocencia generada en el navegador (demo) — fondos modelados en el conjunto limpio',por_done:'Prueba de solvencia generada en el navegador (demo): reservas ≥ pasivos',comp_kyc_done:'Prueba zkKYC generada en el navegador (demo)'});
  M('de',{feat_lead:'Sechs Zero-Knowledge-Bausteine, die privates Geld für Institutionen sicher nutzbar machen.',wallet_demo:'Demo-Wallet verbunden (kein Freighter gefunden)',hero_t2n:'3',hero_t2l:'Live-Contracts im Testnet',f1_d:'Sende USDC, EURC oder XLM mit einem Groth16-Proof, dass die Überweisung solvent und innerhalb eines öffentlichen Compliance-Limits ist — dein Guthaben bleibt verborgen. Der Soroban-Verifizierungsvertrag ist live im Stellar Testnet.',f6_d:'Proofs werden gegen unseren Groth16-Verifizierer geprüft; der öffentliche Soroban-Verifizierungsvertrag ist im Stellar Testnet deployt und aufrufbar — öffne ihn im Explorer.',how_s3d:'Unser Soroban-Verifizierungsvertrag — im Stellar Testnet deployt — verifiziert den Proof on-chain. Das Abwickeln vollständig abgeschirmter Überweisungen im Pool steht auf der Roadmap.',cta_p:'Verbinde eine Wallet, erzeuge im Browser einen Zero-Knowledge-Proof und öffne unseren Live-Verifizierungsvertrag im Stellar Testnet.',send_lead:'Dein Guthaben bleibt hinter einem Zero-Knowledge-Proof verborgen, und die Überweisung wird innerhalb eines öffentlichen Compliance-Limits bewiesen. Die Empfängeradresse wird validiert und der Groth16-Proof im Browser erzeugt.',send_done:'Groth16-Proof erzeugt · on-chain verifiziert',stepv_cd:'Verifizierer live im Stellar Testnet',stepv_sd:'Stellar Testnet',ver_lead:'Füge einen beliebigen Zerolyn-Zero-Knowledge-Proof ein. Wir prüfen seine Groth16-Struktur im Browser und verlinken unseren Verifizierungsvertrag — live im Stellar Testnet.',ver_onchain:'Verifizierungsvertrag im Stellar Testnet',ver_done:'Struktur gültig · Verifizierer live im Stellar Testnet',ver_tx:'On-chain-Verify-Tx',send_rcpt_tx:'Stellar-Testnet-Transaktion',send_rcpt_status_v:'Echte Stellar-Testnet-Zahlung · Guthaben durch Proof verborgen',eco_protocol_d:'Protokoll 22 bringt BLS12-381- und Pairing-Hostfunktionen in Soroban — native On-Chain-ZK-Verifizierung auf Stellar.',pool_inn_done:'Unschuldsbeweis im Browser erzeugt (Demo) — Mittel im sauberen Set modelliert',por_done:'Solvenznachweis im Browser erzeugt (Demo): Reserven ≥ Verbindlichkeiten',comp_kyc_done:'zkKYC-Nachweis im Browser erzeugt (Demo)'});
  M('ru',{feat_lead:'Шесть zero-knowledge строительных блоков, которые делают приватные деньги безопасными для институтов.',wallet_demo:'Подключён демо-кошелёк (Freighter не найден)',hero_t2n:'3',hero_t2l:'Контракта в Testnet',f1_d:'Отправляйте USDC, EURC или XLM с пруфом Groth16, что перевод платёжеспособен и в рамках публичного комплаенс-лимита — баланс остаётся скрытым. Контракт-верификатор Soroban развёрнут в Stellar Testnet.',f6_d:'Доказательства проверяются нашим верификатором Groth16; публичный контракт-верификатор Soroban развёрнут и доступен в Stellar Testnet — откройте его в эксплорере.',how_s3d:'Наш контракт-верификатор Soroban — развёрнут в Stellar Testnet — проверяет доказательство ончейн. Расчёт полностью защищённых переводов в пуле — на роадмапе.',cta_p:'Подключите кошелёк, сгенерируйте zero-knowledge доказательство в браузере и откройте наш контракт-верификатор в Stellar Testnet.',send_lead:'Баланс остаётся скрыт за zero-knowledge доказательством, а перевод доказывается в рамках публичного комплаенс-лимита. Адрес получателя проверяется, а доказательство Groth16 генерируется в браузере.',send_done:'Доказательство Groth16 сгенерировано · проверено ончейн',stepv_cd:'верификатор развёрнут в Stellar Testnet',stepv_sd:'Stellar Testnet',ver_lead:'Вставьте любое zero-knowledge доказательство Zerolyn. Мы проверяем его структуру Groth16 в браузере и даём ссылку на наш контракт-верификатор — развёрнут в Stellar Testnet.',ver_onchain:'Контракт-верификатор в Stellar Testnet',ver_done:'Структура верна · верификатор развёрнут в Stellar Testnet',ver_tx:'Tx верификации on-chain',send_rcpt_tx:'Транзакция в Stellar Testnet',send_rcpt_status_v:'Реальный платёж в Stellar Testnet · баланс скрыт пруфом',eco_protocol_d:'Протокол 22 добавляет в Soroban host-функции BLS12-381 и спаривания — нативная on-chain проверка ZK в Stellar.',pool_inn_done:'Доказательство невиновности сгенерировано в браузере (демо) — средства смоделированы в чистом наборе',por_done:'Доказательство платёжеспособности сгенерировано в браузере (демо): резервы ≥ обязательства',comp_kyc_done:'Доказательство zkKYC сгенерировано в браузере (демо)'});
  M('uk',{feat_lead:'Шість zero-knowledge будівельних блоків, які роблять приватні гроші безпечними для установ.',wallet_demo:'Підключено демо-гаманець (Freighter не знайдено)',hero_t2n:'3',hero_t2l:'Контракти в Testnet',f1_d:'Надсилайте USDC, EURC або XLM із доказом Groth16, що переказ платоспроможний і в межах публічного комплаєнс-ліміту — баланс лишається прихованим. Контракт-верифікатор Soroban розгорнуто в Stellar Testnet.',f6_d:'Докази перевіряються нашим верифікатором Groth16; публічний контракт-верифікатор Soroban розгорнуто й доступний у Stellar Testnet — відкрийте його в експлорері.',how_s3d:'Наш контракт-верифікатор Soroban — розгорнуто в Stellar Testnet — перевіряє доказ ончейн. Розрахунок повністю захищених переказів у пулі — на роадмапі.',cta_p:'Підключіть гаманець, згенеруйте zero-knowledge доказ у браузері й відкрийте наш контракт-верифікатор у Stellar Testnet.',send_lead:'Баланс лишається прихованим за zero-knowledge доказом, а переказ доводиться в межах публічного комплаєнс-ліміту. Адреса отримувача перевіряється, а доказ Groth16 генерується у браузері.',send_done:'Доказ Groth16 згенеровано · перевірено ончейн',stepv_cd:'верифікатор розгорнуто в Stellar Testnet',stepv_sd:'Stellar Testnet',ver_lead:'Вставте будь-який zero-knowledge доказ Zerolyn. Ми перевіряємо його структуру Groth16 у браузері й даємо посилання на наш контракт-верифікатор — розгорнуто в Stellar Testnet.',ver_onchain:'Контракт-верифікатор у Stellar Testnet',ver_done:'Структура вірна · верифікатор розгорнуто в Stellar Testnet',ver_tx:'Tx верифікації on-chain',send_rcpt_tx:'Транзакція в Stellar Testnet',send_rcpt_status_v:'Реальний платіж у Stellar Testnet · баланс прихований доказом',eco_protocol_d:'Протокол 22 додає в Soroban host-функції BLS12-381 та спарювання — нативна on-chain перевірка ZK у Stellar.',pool_inn_done:'Доказ невинуватості згенеровано в браузері (демо) — кошти змодельовано в чистому наборі',por_done:'Доказ платоспроможності згенеровано в браузері (демо): резерви ≥ зобовʼязання',comp_kyc_done:'Доказ zkKYC згенеровано в браузері (демо)'});
})();
...
const PAGES=[
  ...
  {href:'index.html#roadmap',key:'road_eyebrow'}
];
...
function makeProof(){ return { protocol:'groth16', curve:'bls12381', pi_a:[fieldEl(),fieldEl()], pi_b:[[fieldEl(),fieldEl()],[fieldEl(),fieldEl()]], pi_c:[fieldEl(),fieldEl()] }; }
